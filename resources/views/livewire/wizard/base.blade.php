<div class="mx-auto w-full flex flex-col justify-start items-center space-y-2">
    ...
    <div class="p-1 md:p-0 max-w-sm w-full space-y-2">
        <div class="border border-gray-300 shadow-sm shadow-zinc-500 p-2 overflow-y-auto overflow-x-clip" style="height:70vh" id="wizardBox">
